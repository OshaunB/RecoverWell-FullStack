        ...
        <div className="bg-gray-900">
            <div className="flex w-full">
                <div className="flex align-center justify-center bg-red-200 ml-8 ">
                    <img className="w-5/6 my-8 mx-12 bg-orange-200 shadow-2xl" src={currentUser.avatar} alt="" />
                </div>
                <div className="flex w-full mx-8 items-center ">
                    <div className="w-1/2">
                        ...
                        {!!isCurrentUserProfile && <button className="text-3xl font-medium text-orange-400 py-2" onClick={handleLogout}>Log Out</button>}
                    </div>
                    <div className="w-1/2">
