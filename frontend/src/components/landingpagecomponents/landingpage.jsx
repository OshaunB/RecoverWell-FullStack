      ...
      <section className="bg-">
        <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12  ">
          <div className="mr-auto place-self-center lg:col-span-7">
            <h1 className="max-w-2xl mb-4 text-4xl font-extrabold leading-none md:text-5xl xl:text-6xl text-slate-900">
            ...
            <a
              href="#"
              className="inline-flex items-center justify-center px-5 py-3 mr-3 text-blue-900 font-medium text-center text-white rounded-lg bg-neutral-50 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900"
            >
          ...
          <div className="grid gap-8 lg:grid-cols-3">
            <div className="flex flex-col items-center">
              ...
              <p className="mt-2 text-base text-center text-gray-500 dark:text-gray-400">
                The strength of recovery lies not only within the individual
                but also in the bonds forged within a community. It is in this
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="mt-2 text-base text-center text-gray-500 dark:text-gray-400">
                In the tapestry of recovery, support weaves threads of
                strength, hope, and healing, guiding individuals towards a
                future adorned with triumph and renewed purpose.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
          <div className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
            ...
            <p className="mb-4 text-white">
              Here art RecoverWell , we understand the day to day life of an
