...
export default function LoginPage() {
  ...
  <div className="hidden bg-cover lg:block lg:w-1/2" style={{backgroundImage: "url('assets/coz_a_beautiful_peaceful_image_of_a_buddhist_monk_meditating_su_7d51d875-94dd-4dcd-b0a5-bee60b91822d.png')"}}></div>

  <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
    <div className="flex justify-center mx-auto">
      <img className="w-auto h-7 sm:h-8" src="assets/RecoverWell Dummy Logo.PNG" alt="" />
    </div>
    ...
    <a href="#" className="flex items-center justify-center mt-4 text-white transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 bg-gray-800">
    ...
    <div className="flex items-center justify-between mt-4">
      ...
      <a href="#" className="text-xs text-center text-gray-500 uppercase dark:text-gray-400 hover:underline">or login with Username</a>

      <span className="w-1/5 border-b dark:border-gray-400 lg:w-1/4"></span>
    </div>

    <div className="mt-4">
      <label className="block mb-2 text-sm font-medium text-gray-600 dark:text-gray-200" htmlFor="LoggingEmailAddress">Email Address / UserName</label>
